...
class __TwigTemplate_1574149e36601488720e3b9d04224f762635b8588e7d5f0cefa1b6d8efdf1e99 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["reservation"]) {
            ...
            echo "</td>
                <td>";
            // line 24
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reservation"], "userId", [], "any", false, false, false, 24), "html", null, true);
            echo "</td>
                <td>";
            // line 25
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reservation"], "eventId", [], "any", false, false, false, 25), "html", null, true);
            echo "</td>
                <td>";
            // line 26
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reservation"], "nom", [], "any", false, false, false, 26), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 28
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reservation_show", ["id" => twig_get_attribute($this->env, $this->source, $context["reservation"], "id", [], "any", false, false, false, 28)]), "html", null, true);
            echo "\">show</a>
...
";
    ...
    {
        return array (  149 => 37,  140 => 33,  130 => 28,  125 => 26,  121 => 25,  117 => 24,  113 => 23,  110 => 22,  105 => 21,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
   ...
   <!-- <a href=\"{ path('app_reservation_new') }}\">Create new</a>-->
{% endblock %}
", "reservation/index.html.twig", "C:\\wamp64\\www\\FirstProject - Copie\\templates\\reservation\\index.html.twig");
    }
}
