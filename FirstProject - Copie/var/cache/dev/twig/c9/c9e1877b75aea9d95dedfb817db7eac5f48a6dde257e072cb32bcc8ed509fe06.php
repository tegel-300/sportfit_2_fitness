...
class __TwigTemplate_b9879bf17e8950b4d025650be6fcda4da35790de0155cf12769c15f6583cc9b3 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        ...
        echo "\"><button style=\"background-color: #ACFF65\">back to list</button></a>
...
{% block body %}
    ...
    <a href=\"{{ path('app_reservation_index') }}\"><button style=\"background-color: #ACFF65\">back to list</button></a>

   <!-- <a href=\"{ path('app_reservation_edit', {'id': reservation.id}) }}\">edit</a>-->

    {{ include('reservation/_delete_form.html.twig') }}
{% endblock %}
", "reservation/show.html.twig", "C:\\wamp64\\www\\FirstProject - Copie\\templates\\reservation\\show.html.twig");
    }
}
